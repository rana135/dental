...
const Footer = () => {
    ...
    return (
        <div>
            <footer class="footer p-10 bg-gradient-to-r from-secondary to-primary text-white mt-28">
                <div>
                    <span class="footer-title">Support</span>
                    <Link to='/' className="link link-hover">Contact Us</Link>
                    <Link to='/' className="link link-hover">FAQ</Link>
                    <Link to='/' className="link link-hover">Get An Appointment</Link>
                    <Link to='/' className="link link-hover">Help Center</Link>
                    <Link to='/' className="link link-hover">Ticket System</Link>
                </div>
                <div>
                    <span class="footer-title">Company</span>
                    <Link to='/' className="link link-hover">About us</Link>
                    <Link to='/' className="link link-hover">Leadership</Link>
                    <Link to='/' className="link link-hover">History</Link>
                    <Link to='/' className="link link-hover">Careers</Link>
                    <Link to='/' className="link link-hover">Legal Notice</Link>
                </div>
                <div>
                    ...
                    <Link to='/' className="link link-hover">Patient Right and Advocacy</Link>
                </div>
            </footer>
            <footer class="footer px-10 py-4 border-t bg-gradient-to-r from-secondary to-primary text-white">
                <div class="items-center grid-flow-col">
                    <h1 className='font-bold text-3xl'>#</h1>
                    <p>Dental Clinic.<br />
                        Copyright © {currentYear} - All right reserved by Md Rana Hossain</p>
                </div>
